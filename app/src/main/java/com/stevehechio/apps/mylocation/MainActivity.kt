package com.stevehechio.apps.mylocation
...
class MainActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private lateinit var foregroundRemoveLocationButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        foregroundOnlyLocationButton = findViewById(R.id.request_location_updates_button)
        outputTextView = findViewById(R.id.textView)
        foregroundRemoveLocationButton = findViewById(R.id.remove_location_updates_button)

        foregroundRemoveLocationButton.setOnClickListener {
            if (foregroundPermissionApproved()) {
            client.lastLocation.addOnSuccessListener {
                val outputWithPreviousLogs = "current lat ${it.latitude}" +
                        "current lng ${it.longitude}\n${outputTextView.text}"
                outputTextView.text = outputWithPreviousLogs
            }.addOnFailureListener { outputTextView.text = it.message }
        }  }
